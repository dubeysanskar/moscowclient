...
/* ─── Desktop horizontal-scroll variant ─── */
function DesktopScroll({ services, lang }) {
    ...
    // Translate from 0px to -(2 cards * ~440px + 2 gaps * 24px) = ~-928px
    // Using percentage of the element: 2/5 cards = 40% + gap compensation
    const x = useTransform(scrollYProgress, [0.02, 0.98], ["0%", "-43%"])

    return (
        <section ref={sectionRef} className="relative hidden lg:block" style={{ background: "#FDFBEF", height: "450vh" }}>
